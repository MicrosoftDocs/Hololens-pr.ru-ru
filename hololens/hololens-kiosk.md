...
### <a name="how-to-can-visitor-accounts-automatically-logon-into-kiosk-experience"></a>Как можно автоматически войти в киоск с учетными записями посетителей?
...
### <a name="is-kiosk-experience-supported-on-hololens-1st-gen"></a>Поддерживается ли киоск в Hololens (1-й общий)?
