...
Разработчик приложения может использовать преимущества связанных удостоверений на HoloLens с помощью [API диспетчера учетных записей Windows](https://docs.microsoft.com/uwp/api/Windows.Security.Authentication.Web.Core)так же, как и на других устройствах с Windows. [Ниже](https://go.microsoft.com/fwlink/p/?LinkId=620621)приведены некоторые примеры кода для этих API-интерфейсов.
