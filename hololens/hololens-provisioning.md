...
1. Подключите устройство к компьютеру с помощью USB-кабеля и запустите устройство. Не продолжайте пользоваться **первой просматриваемой** страницей Oobe.   
...
5. Снова одновременно и кратковременно нажмите и отпустите кнопки **уменьшения громкости** и **питания**, находясь на странице **настройки**.
...
### 4. Примените пакет подготовки к HoloLens после настройки.

> [!NOTE]
> Эти действия применимы только к toWindows 10, версия 1809.
...
> [!NOTE]
> HoloLens в настоящее время не поддерживает установку приложений (**UniversalAppInstall**) с помощью пакета подготовки.
