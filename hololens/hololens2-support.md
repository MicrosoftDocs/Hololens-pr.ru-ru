...
>[!Note]
>Используйте один из номеров коммерческих телефонов службы технической поддержки, чтобы завершить покупку. 

>[!Note]
>Если вы звоните для поддержки с рынка, который не указан ниже, направьте свой звонок на наш номер рабочего стола США.

| Рынки | Номер рабочего стола | Часы работы |
|-----------------|-------------------|-----------------------|
| Соединенное Королевство | + 44 800 026 0061 | От ПН до пт, 09AM до 18:00 |
| Германия | + 49 08 05 98 00 03 | От ПН до пт, 09AM до 18:00 |
| Швеция    | + 46 20 120 3222   | От ПН до пт, 09AM до 18:00 |
| Швейцария | + 41 800 662006 |    От ПН до пт, 09AM до 18:00 |
| Бельгия | + 32 80058153 |  От ПН до пт, 09AM до 18:00 |
| Нидерланды | + 31 8007482055 |    От ПН до пт, 09AM до 18:00 |
| Австрия | + 43 800 943670 |    От ПН до пт, 09AM до 18:00 |
| Дания | + 45 80400184 |  От ПН до пт, 09AM до 18:00 |
| Ирландия | + 353 1800 832 653 | От ПН до пт, 09AM до 18:00 |
| Италия |   + 39 800598979 | От ПН до пт, 09AM до 18:00 |
| Люксембург |  + 352 80040425 | От ПН до пт, 09AM до 18:00 |
| Испания |    + 34 800 598979 |   От ПН до пт, 09AM до 18:00 |
| Норвегия |  + 47 80062002 |  От ПН до пт, 09AM до 18:00 |
| Финляндия | + 358 800526136 |    От ПН до пт, 09AM до 18:00 |
| Португалия |    + 351 800600087 |    От ПН до пт, 09AM до 18:00 |
| США |  866-425-4709 |  От мес к Пятница, 06:00 до 18:00, PST |
| Канада |  877-345-2661 |  От мес к Пятница, 06:00 до 18:00, PST |
| Китай |   400-805-6783 |  От ПН до пт, 9:00 до 18:00 |
| Япония |   0120-03-5241 |  От мес до Пятница, 9:00 до 5:30 |
| Австралия |   1800-217-709 |  От ПН до пт, 8:00 до 20:00 |
| Сингапур |   1800 622-1816 | От мес до Пятница, 8:10:30 до 5:30 |
| Новая Зеландия | 0800 471 640 |  От ПН до пт, 8:00 до 18:00 |

>[!IMPORTANT]
>Если вам нужна полная накладная по НДС, вы должны получить доступ к группе коммерческих магазинов напрямую и не приобретать устройство в сети. Все покупки, сделанные в Интернете, будут получать только упрощенный счет НДС, который нельзя изменить позже.

## <a name="azure-mixed-reality-services-support"></a>Поддержка служб Azure Mixed Reality

### <a name="open-an-azure-portal-technical-support-ticket"></a>Открытие запроса в службу технической поддержки портал Azure

Чтобы открыть запрос в службу технической поддержки на портал Azure для пространственных привязок Azure, привязок объектов Azure или удаленной подготовки к просмотру Azure:
...
3. При заполнении полей заявки в службу поддержки укажите:
    ...
    2. Заполните форму как можно более точным и подробным, а также желаемым способом.

    3. Ознакомьтесь со всеми сведениями, которые вы заполнили в предыдущих разделах, и отправьте запрос в службу поддержки.
...
>[!Note]
>Обратная связь — это отличный способ слышать ваш речевой ответ, но отзывы и предложения не являются способом получения ответа. Центр обратной связи может сочетаться с другими вариантами поддержки.
