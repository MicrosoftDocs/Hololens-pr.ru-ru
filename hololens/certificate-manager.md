...
- введено в [Windows holographic, version 21H2](hololens-release-notes.md#windows-holographic-version-21h2).
 ...
 Мы добавили поддержку диспетчера сертификатов, чтобы использовать PFX-сертификаты. когда пользователь переходит к **Параметры**  >  **Update &**  >  **сертификаты** безопасности и выбирает **установить сертификат** , пользовательский интерфейс теперь поддерживает pfx-файл сертификата.
