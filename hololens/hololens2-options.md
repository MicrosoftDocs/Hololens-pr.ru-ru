...
Независимо от того, являетесь ли вы [ИТ-специалистом](https://www.microsoft.com/hololens/apps), подыскивающим свое следующее отраслевое решение, [разработчиком](https://www.microsoft.com/hololens/developers), желающим создавать интерфейсы для новой реальности, или [специалистом по принятию деловых решений](https://www.microsoft.com/hololens/apps), размышляющим о следующем нововведении, — HoloLens 2 станет вашей новой реальностью для вычислений.

<br>

|                                                      | HoloLens 2 | HoloLens 2 с удаленной поддержкой | HoloLens 2 Industrial Edition | HoloLens 2 Industrial Edition с удаленной поддержкой | Trimble XR10 с HoloLens 2 | HoloLens 2 Development Edition |
|------------------------------------------------------|------------|-------------------------------|-------------------------------|--------------------------------------------------|------------------------------|--------------------------------|
...
| В комплекте с защитной каской (соответствие требованиям к СИЗ в более чем 40 странах) |            |                               |                               |                                                  |               ✔️              |                                |
...
| Выпуск HoloLens 2                  | Поддерживаемые регионы               |
|-------------------------------------------| ----------------------------------------| 
| HoloLens 2 | США, Канада, Германия, Франция, Соединенное Королевство, Ирландия, Китай, Япония, Австралия, Италия, Новая Зеландия, Нидерланды, Швейцария, Испания, Австрия, Швеция, Финляндия, Норвегия, Дания, Бельгия, Португалия, Польша, Сингапур, Гонконг (САР), Тайвань и Южная Корея |
| HoloLens 2 с удаленной поддержкой | Австралия, Япония, Канада, США, Австрия, Бельгия, Дания, Финляндия, Франция, Германия, Италия, Нидерланды, Норвегия, Испания, Швеция, Швейцария, Соединенное Королевство и Ирландия <sup>1</sup> 
| HoloLens 2 Industrial Edition *(при запуске)* | США, Канада, Германия, Франция, Соединенное Королевство, Ирландия, Китай, Япония, Австралия, Италия, Новая Зеландия, Нидерланды, Швейцария, Испания, Австрия, Швеция, Финляндия, Норвегия, Дания, Бельгия, Португалия, Польша, Сингапур, Гонконг (САР), Тайвань и Южная Корея |
| HoloLens 2 Development Edition | Канада, Германия, Франция, Соединенное Королевство, Ирландия, Япония, Австралия, Италия, Швейцария и Новая Зеландия |
- <sup>1</sup> Это изменяющийся список, периодически проверяйте обновления
...
**[HoloLens 2 с Dynamics 365 Remote Assist](hololens2-options.md#hololens-2-with-remote-assist)**. Одновременно начните работу с HoloLens 2 и первоклассным приложением для общения в смешанной реальности от Майкрософт, которые доступны вместе. Повысьте производительность всей организации и внедряйте дополнительные нововведения. Насладитесь смешанной реальностью с Dynamics 365 и решениями отраслевых партнеров.

**[HoloLens 2 Industrial Edition](hololens2-options.md#hololens-2-industrial-edition)**. Разработан, создан и протестирован для поддержки сред чистых помещений по стандартам от ISO класса 6 до ISO класса 8. Выпуск HoloLens 2 Industrial Edition содержит сертификат UL класса I, раздела 2 и поддерживается в рамках 2-летней гарантии и программы быстрой замены.

**[Trimble XR10 с HoloLens 2](hololens2-options.md#trimble-xr10-with-hololens-2)**. Устройство Trimble XR10 с HoloLens 2, специально созданное для сотрудников в пыльных и шумных средах с применением мер по обеспечению безопасности, добавляет смешанную реальность прямо на рабочую площадку.

**[HoloLens 2 Development Edition](hololens2-options.md#hololens-2-development-edition)**. Начните разработку для смешанной реальности с помощью этого предложения, объединяющего HoloLens 2 с бесплатными пробными версиями программного обеспечения Unity и кредитами Azure для облачных служб. Узнайте, как расширить базовые возможности и начать разработку для смешанной реальности.
...
|-------------|----------------------------------------|
| [Начало работы](https://docs.microsoft.com/dynamics365/mixed-reality/remote-assist/overview-hololens) | Начало работы с удаленной поддержкой.        |
| [Лицензия](https://docs.microsoft.com/dynamics365/mixed-reality/remote-assist/deploy-remote-assist#add-and-assign-licenses)     | Активация лицензии для удаленной поддержки.      |
...
- **Опасные расположения.** HoloLens 2 Industrial Edition поддерживает среды с наличием горючих газов, паров или жидкостей, которые обычно не присутствуют в воспламеняющихся концентрациях при нормальной эксплуатации, а также включает сертификацию UL класса I, раздел 2 — группы A, B, C и D опасных зон (HAZLOC).
...
HoloLens 2 Development Edition включает HoloLens 2, 500 долл. США в виде кредитов Azure, 3-месячную пробную версию Unity Pro и 3-месячную пробную версию подключаемого модуля PiXYZ:

| Пакетная функция | Описание |
|---|---|
...
1. Введите код продукта и нажмите **Активировать код продукта**
...
1. Посетите страницу [id.unity.com](http://id.unity.com/)
1. Щелкните **Активировать код продукта**
1. Введите код подключаемого модуля Pixyz и нажмите **Активировать код продукта**
...
|     Контрольная точка                              |     Результат                                                                                                                    |
|---------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|
|     [Начало разработки и создания прототипов](https://docs.microsoft.com/windows/mixed-reality/design/design)         |     Начните разработку приложений смешанной реальности с основных понятий, моделей взаимодействия и элементов пользовательского интерфейса.     |
...
- [Сведения об объединении MRTK с Unity](https://docs.microsoft.com/windows/mixed-reality/develop/unity/mrtk-getting-started).
- [Сведения о развертывании созданных приложений](https://docs.microsoft.com/hololens/app-deploy-overview).
- [Знакомство со всеми возможностями смешанной реальности](https://docs.microsoft.com/windows/mixed-reality/).
...
[Корпоративное развертывание и управление HoloLens 2](hololens-requirements.md)

Мы создали для вас несколько руководств по развертыванию. Ознакомьтесь с нашим [обзором распространенных сценариев развертывания инфраструктуры](common-scenarios.md) и найдите развертывание, оптимально подходящее для ваших потребностей.
...
| [Dynamics 365 Remote Assist](https://dynamics.microsoft.com/mixed-reality/remote-assist/)          | Предоставление техническим специалистам возможности для более эффективной совместной работы из разных мест. |
|   [Руководства по Dynamics 365](https://dynamics.microsoft.com/mixed-reality/guides/)        | Улучшение обучения под существующие потребности и знакомство с производительностью сотрудников.                          |
|  [Облачные службы Azure для смешанной реальности](https://docs.microsoft.com/windows/mixed-reality/develop/mixed-reality-cloud-services#:~:text=Mixed%20Reality%20services%20Mixed%20Reality%20cloud%20services%20like,all%20in%20the%20context%20of%20your%20users%E2%80%99%20environments)         | Узнайте, как разработать решение с помощью облачных служб Azure.                                       |
|  [Начало разработки для HoloLens 2](https://docs.microsoft.com/windows/mixed-reality/develop/development?tabs=unity)         | Создайте решение смешанной реальности, подходящее для ваших потребностей.                                                 |
